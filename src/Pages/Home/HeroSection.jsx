        ...
        <div className='bg-theme-accent select-none py-12 md:py-20'>
            <div className='max-w-7xl mx-auto px-2 flex md:flex-row flex-col-reverse justify-between items-center w-full my-auto'>
                ...
                <div className='w-full md:w-1/2 py-6 md:py-0 flex flex-col gap-6'>
                    ...
                    <p className='text-slate-600 text-lg'>MindWave: Where Minds Unite to Empower Growth and Creativity. Immerse yourself in a dynamic community of bloggers, where insightful exploration and shared wisdom fuel the journey of personal evolution.</p>
